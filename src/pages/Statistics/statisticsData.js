export const DASHBOARD_DATA = [
  ...
  {
    question: "2",
    title: "Users, Contagem, Agrupado por Created At (month)",
    src:
      "http://localhost:3002/embed/question/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZXNvdXJjZSI6eyJxdWVzdGlvbiI6Mn0sInBhcmFtcyI6e30sImV4cCI6MTYwNjI2MzgxOCwiaWF0IjoxNjA2MjYzMjE4fQ.DOLDhvPu5OGvag8IbXysXA-Ljg1fexQFOyKR6IsqFDw#bordered=true&titled=true",
    frameborder: "0",
    width: "800",
    height: "600",
    //"allowtransparency"
  ...
  {
    question: "3",
    title: "Surveys, Filtrado por State",
    src:
      "http://localhost:3002/embed/question/eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyZXNvdXJjZSI6eyJxdWVzdGlvbiI6NH0sInBhcmFtcyI6e30sImV4cCI6MTYwNTQ1MjM4MywiaWF0IjoxNjA1MzkyMzgyfQ.bSL0NvJmEp-dX-36NW7Xar1yzpV1o3ntaE_O9N17Yt0#bordered=true&titled=true",
    frameborder: "0",
    width: "800",
    height: "600",
    //"allowtransparency"
